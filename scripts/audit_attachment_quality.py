"""Audit attachment download and parsing metadata in raw notice JSON files."""
...
from crawler.quality import audit_attachment_quality, load_raw_notices


def main() -> None:
    parser = argparse.ArgumentParser(description="Audit attachment parsing quality.")
    ...
    report = audit_attachment_quality(notices, files_dir)
    ...
    print("[attachment-quality audit]")
